#    MTUOC_tokenizer_jap_fugashi 4.0
...
class Tokenizer():
    ...
    def tokenize_fugashi(self,segment):
        
        tokens = [token.surface for token in self.tagger(segment)]
        return(tokens)

    def tokenize(self, segment):
        seg_list = self.tokenize_fugashi(segment)
